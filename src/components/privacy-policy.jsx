    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Kodiqe, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Kodiqe.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            At Kodiqe, we will only request personal information when it is
          ...
          <p className="mb-4">
            If Kodiqe invites you to complete and submit an online form, your
          ...
          <p className="mb-4">
            It's important to note that while Kodiqe may track a visitor's
          ...
          <p className="mb-4">
            Kodiqe may utilize your personal information to:
          </p>
          <ul>
            <li>
          ...
          <p className="mb-4">
            If you wish to be removed from any Kodiqe distribution list, simply
            click on the provided link within each electronic communication or
            reply to the email with the subject line "unsubscribe".
          </p>
          <p className="mb-4">
            If you have provided your telephone number to Kodiqe, you may
          ...
          <p className="mb-4">
            The Kodiqe website may contain links to external websites, including
            partner websites. It is advisable to review the privacy policies and
            other guidelines of these third-party sites, as they are not
            governed by Kodiqe's privacy policy. Kodiqe has no control over the
            content or information gathering practices of these external sites.
          </p>
          <p className="mb-4">
            Please note that this Privacy Policy specifically pertains to
            Kodiqe's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Kodiqe
          ...
          <p className="mb-4">
            ...
            paramount at Kodiqe. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Kodiqe, we remain committed to upholding the highest standards of
            data protection, providing you with peace of mind as you engage with
            our services.
          </p>
          <p className="font-semibold mb-2">EU-US Privacy Shield</p>
          <p className="mb-4">
            For individuals residing in the European Economic Area (EEA), Kodiqe
            remains fully compliant with the EU-US Privacy Shield framework
            established by the United States Department of Commerce. This
            framework governs the collection, retention, and use of personal
            data from EEA countries, ensuring adherence to stringent privacy
            standards.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            At Kodiqe, we are committed to maintaining the highest standards of
          ...
          <p className="mb-4">
            Kodiqe is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Kodiqe is
          ...
          <p className="mb-4">
            Kodiqe is subject to the investigative and enforcement authority of
          ...
          <p className="mb-4">
            Kodiqe reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Kodiqe’s website to stay informed of any updates.
