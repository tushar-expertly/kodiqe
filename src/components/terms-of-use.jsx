    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            When utilizing the Kodiqe website, you may come across documents or
          ...
          <p className="mb-4">
            ...
            made to ensure the information is accurate and current, Kodiqe
            cannot guarantee the accuracy or authenticity of information
            originating from third parties. Kodiqe is not liable for any
          ...
          <p className="mb-4">
            ...
            Kodiqe is not liable for any actions or omissions resulting from
